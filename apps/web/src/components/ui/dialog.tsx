    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "max-lg:inset-x-0 max-lg:bottom-0 max-lg:top-auto max-lg:left-0 max-lg:max-w-none max-lg:max-h-[90dvh] max-lg:translate-x-0 max-lg:translate-y-0 max-lg:overflow-y-auto max-lg:overscroll-contain max-lg:rounded-t-2xl max-lg:rounded-b-none max-lg:pb-[max(1.5rem,env(safe-area-inset-bottom))] max-lg:transform-gpu max-lg:[will-change:transform] max-lg:[backface-visibility:hidden] max-lg:touch-pan-y max-lg:data-[state=closed]:slide-out-to-bottom max-lg:data-[state=open]:slide-in-from-bottom max-lg:data-[state=open]:duration-200",
          // Swipe the grab handle up to expand (height animated by useSheetDrag);
          // give the search palette's result list the extra room too.
          "max-lg:data-[expanded=true]:max-h-[96dvh] max-lg:data-[expanded=true]:[&_[data-slot=command-list]]:max-h-[84dvh]",
